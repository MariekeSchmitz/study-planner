...
//        Exam e = new Exam(1.3f, ExamType.EXAM, OfferedTime.BI_YEARLY, 2, true);
        Course course1 = new Course("Vorlesung", 3, new Exam(ExamType.EXAM, OfferedTime.BI_YEARLY, 2, true), neededCompetences);
        courses1.add(course1);
        
        List<Course> courses2 = new ArrayList<>();
        Course course2 = new Course("Praktikum", 3, new Exam(ExamType.EXAM, OfferedTime.BI_YEARLY, 2, false), neededCompetences);
...
//        Module prog1 = new Module("Programmieren 1", "Programmieren undso", 1, 1, OfferedTime.YEARLY, courses1, neededCompetences, infl, true, "");
//        Module eidm = new Module("Einfuehrung in die Medieninformatik", "Einfuehrung halt", 2, 2, OfferedTime.YEARLY, courses2, neededCompetences, infl, true, "");
//        
//        modules.add(prog1);
//        modules.add(eidm);
        
        
        Module prog1 = new Module("Programmieren 1", "Programmieren undso", 1, 1, OfferedTime.YEARLY, courses1,
                neededCompetences, infl, true, "");
        Module eidm = new Module("Einfuehrung in die Medieninformatik", "Einfuehrung halt", 1, 1, OfferedTime.YEARLY,
        ...
        Module alge = new Module("Algorithmen und Datenstrukturen", "Schlaues Codingzeugs", 2, 2, OfferedTime.YEARLY, 
                courses1, Arrays.asList(new Competence("Analysis"), new Competence("Programmieren 1"),
        ...
        Module itrecht = new Module("IT-Recht und Datenschutz", "DSGVO undso", 2, 2, OfferedTime.YEARLY,  courses1,
                neededCompetences, fql, true, "");
        ...
        Module prog3 = new Module("Programmieren 3", "Mega Advanced Programmieren undso", 3, 3, OfferedTime.YEARLY, 
                courses1, Arrays.asList(new Competence("Auszeichnungssprachen"), new Competence("Programmieren 2"),
        ...
        Module angeMath = new Module("Angewandte Mathematik", "Basically Stochastik", 3, 3, OfferedTime.YEARLY, 
                courses1, Arrays.asList(new Competence("Analysis"), new Competence("Lineare Algebra")), mathl, true, "");
        Module data = new Module("Datenbanken", "Umgang mit DBs", 3, 3, OfferedTime.YEARLY, courses1,
                Arrays.asList(new Competence("Lineare Algebra"), new Competence("Programmieren 2"),
                        new Competence("Algorithmen und Datenstrukturen")),
                infl, true, "");
        Module auto = new Module("Automatentheorie und formale Sprachen", "Umgang mit DBs", 3, 3, OfferedTime.YEARLY, 
        ...
        Module swt = new Module("Softwaretechnik", "Mega Advanced Programmiertheorie", 4, 4, OfferedTime.YEARLY, 
                courses1, neededCompetences, infl, true, "");
        Module cg = new Module("Softwaretechnik", "Krasse Grafikgeschichten mit Schwani", 4, 4, OfferedTime.YEARLY, 
                courses1, neededCompetences, infl, true, "");
        ...
        Module mci = new Module("Mensch-Computer-Interaktion", "Menschen mache Sachen mit Computern", 5, 5,
                OfferedTime.YEARLY, courses1, neededCompetences, gestl, true, "");
        Module wp1 = new Module("Wahlpflichtliste Gestaltung und Informatik", "Wahlpflicht", 5, 5, OfferedTime.YEARLY,
                 courses1, neededCompetences, infgestl, true, "");
        Module wp2 = new Module("Wahlpflichtliste Medien und Informatik", "Wahlpflicht", 5, 5, OfferedTime.YEARLY, 
                courses1, neededCompetences, infl, true, "");
        ...
        Module wp3 = new Module("Wahlpflichtliste Internationalisierung", "Wahlpflicht", 7, 7, OfferedTime.YEARLY, 
                courses1, neededCompetences, fql, true, "");
        Module port = new Module("Portfolio Medieninformatik", "Portfolio", 7, 7, OfferedTime.YEARLY, courses1,
