...
public class TestClassGenerator {
        ...
        private List<Module> getModules() {
                ...
                Module gem = new Module("Gestaltung elektronischer Medien", "Websites undso", 2, 2, OfferedTime.YEARLY,
                                ...
                                "");
                Module itrecht = new Module("IT-Recht und Datenschutz", "DSGVO undso", 2, 2, OfferedTime.YEARLY, 5,
                                courses,
                                neededCompetences, fql, true, "");
                ...
                Module angeMath = new Module("Angewandte Mathematik", "Basically Stochastik", 3, 3, OfferedTime.YEARLY,
                                6,
                                courses, Arrays.asList(new Competence("Analysis"), new Competence("Lineare Algebra")),
                                mathl, true, "");
                ...
                Module netz = new Module("Rechnernetze und Betriebssysteme", "Eigentlich nur Protokolle", 4, 4,
                                OfferedTime.YEARLY, 6, courses, Arrays.asList(new Competence("Programmieren 3")), infl,
                                true, "");
                ...
                Module wp2 = new Module("Wahlpflichtliste Medien und Informatik", "Wahlpflicht", 5, 5,
                                OfferedTime.YEARLY, 10,
                                courses, neededCompetences, infl, true, "");
                modules.addAll(Arrays.asList(swtp, mci, wp1, wp2));

                Module prak = new Module("Berufspraktische Taetigkeit", "Praktikum", 6, 6, OfferedTime.YEARLY, 30,
                                courses,
                                neededCompetences, fql, true, "");
                modules.add(prak);

                Module wp3 = new Module("Wahlpflichtliste Internationalisierung", "Wahlpflicht", 7, 7,
                                OfferedTime.YEARLY, 4,
                                courses, neededCompetences, fql, true, "");
                Module port = new Module("Portfolio Medieninformatik", "Portfolio", 7, 7, OfferedTime.YEARLY, 10,
                                courses,
