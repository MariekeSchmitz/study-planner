...
public class TestClassGenerator {
        ...
        private List<Module> getModules() {
                ...
                Module eidm = new Module("Einfuehrung in die Medieninformatik", "Einfuehrung halt", 1, 1,
                                OfferedTime.YEARLY,
                                getCourses(), neededCompetences, Arrays.asList(new Competence("Einfuehrung in die Medieninformatik")), infl, true, "");
                Module eidg = new Module("Einfuehrung in die Gestaltung", "Einfuehrung halt", 1, 1, OfferedTime.YEARLY,
                                getCourses(), neededCompetences, Arrays.asList(new Competence("Einfuehrung in die Gestaltung")), gestl, true, "");
                Module bwl = new Module("Grundlagen der BWL", "BWL halt", 1, 1, OfferedTime.YEARLY, getCourses(),
                                neededCompetences,Arrays.asList(new Competence("Grundlagen der BWL")), fql, true, "");
                Module analysis = new Module("Analysis", "Mathe 1 halt", 1, 1, OfferedTime.YEARLY, getCourses(),
                ...
                Module prog2 = new Module("Programmieren 2", "Advanced Programmieren undso", 2, 2, OfferedTime.YEARLY,
                                getCourses(), Arrays.asList(new Competence("Programmieren 1"),
                                                new Competence("Einfuehrung in die Medieninformatik")),
                                Arrays.asList(new Competence("Programmieren 2")),infl, true, "");
                Module linealge = new Module("Lineare Algebra", "Mathe 2 halt", 2, 2, OfferedTime.YEARLY, getCourses(),
                ...
                Module gem = new Module("Gestaltung elektronischer Medien", "Websites undso", 2, 2, OfferedTime.YEARLY,
                                getCourses(), Arrays.asList(new Competence("Einfuehrung in die Gestaltung")),Arrays.asList(new Competence("Gestaltung elektronischer Medien")), gestl, true,
                                "");
                ...
                Module asz = new Module("Auszeichnungssprachen", "Html undso", 2, 2, OfferedTime.YEARLY, getCourses(),
                ...
                Module prak = new Module("Berufspraktische Taetigkeit", "Praktikum", 6, 6, OfferedTime.YEARLY, getCourses(),
                                neededCompetences, 
