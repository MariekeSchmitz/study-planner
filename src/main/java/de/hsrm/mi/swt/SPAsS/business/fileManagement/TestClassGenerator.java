...
public class TestClassGenerator {
        ...
        private List<Module> getModules() {
                ...
                Module eidm = new Module("Einfuehrung in die Medieninformatik", "Einfuehrung halt", 1, 1,
                                OfferedTime.YEARLY,
                                courses2, neededCompetences, Arrays.asList(new Competence("Einfuehrung in die Medieninformatik")), infl, true, "");
                Module eidg = new Module("Einfuehrung in die Gestaltung", "Einfuehrung halt", 1, 1, OfferedTime.YEARLY,
                                courses1, neededCompetences, Arrays.asList(new Competence("Einfuehrung in die Gestaltung")), gestl, true, "");
                ...
                Module gem = new Module("Gestaltung elektronischer Medien", "Websites undso", 2, 2, OfferedTime.YEARLY,
                                courses1, Arrays.asList(new Competence("Einfuehrung in die Gestaltung")),Arrays.asList(new Competence("Gestaltung elektronischer Medien")), gestl, true,
                                "");
                ...
                Module netz = new Module("Rechnernetze und Betriebssysteme", "Eigentlich nur Protokolle", 4, 4,
                                OfferedTime.YEARLY, courses1, Arrays.asList(new Competence("Programmieren 3")),
                ...
                Module wp1 = new Module("Wahlpflichtliste Gestaltung und Informatik", "Wahlpflicht", 5, 5,
                                OfferedTime.YEARLY, courses1, neededCompetences, 
