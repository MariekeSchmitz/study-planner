...
public class TestClassGenerator {
        ...
        private List<Module> getModules() {
                ...
                Module bwl = new Module("Grundlagen der BWL", "BWL halt", 1, 1, OfferedTime.YEARLY, getCourses(3,2),
                                neededCompetences,Arrays.asList(new Competence("Grundlagen der BWL")), fql, true, "");
                Module analysis = new Module("Analysis", "Mathe 1 halt", 1, 1, OfferedTime.YEARLY, getCourses(3,2),
                ...
                Module linealge = new Module("Lineare Algebra", "Mathe 2 halt", 2, 2, OfferedTime.YEARLY, getCourses(3,2),
                ...
                Module asz = new Module("Auszeichnungssprachen", "Html undso", 2, 2, OfferedTime.YEARLY, getCourses(3,2),
                ...
                Module data = new Module("Datenbanksysteme", "Umgang mit DBs", 3, 3, OfferedTime.YEARLY, getCourses(3,3),
                ...
                Module animus = new Module("Animation", "Leblose Sachen beleben", 4, 4, OfferedTime.YEARLY, getCourses(3,3),
                ...
                Module prak = new Module("Berufspraktische Taetigkeit", "Praktikum", 6, 6, OfferedTime.YEARLY, 
                ...
                Module bach = new Module("Bachelor Thesis", "Bachelor Thesis", 7, 7, OfferedTime.YEARLY, 
        ...
        private List<Course> getCourses(int cpvl, int cpp){
                ...
                Course course1 = new Course("Vorlesung", cpvl, new Exam(ExamType.EXAM, OfferedTime.BI_YEARLY, 0, false));
